...
\addsymbol{0.07125}{\symbolL $\{b=\b{2}\}$} 
;

\addnote{0.67,0.968}{$1 - \theta - \frac{a2}{p} = \varp $}
...
\addsymbol{0.3,above}{\symbolR  $\{b=\b{2}\}$} 
;
